...
return [
    ...
    */
    ...
    'guards' => [
        ...
        // docs/03 §Auth: the admin panel authenticates on its own guard against its own
        // table. Sharing a guard with the mobile app would let one token type reach both.
        'sanctum-admin' => [
            'driver' => 'sanctum',
